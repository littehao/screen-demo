<template>
  <scale-card title="光通道" iconname="el-icon-pie-chart">
  ...
  export default {
    ...
    methods: {
      ...
      getPie3D(pieData, internalDiameterRatio) {
        ...
        const boxHeight = this.getHeight3D(series, 30)// 通过传参设定3d饼/环的高度，26代表26px
      ...
      bindListen(myChart) {
        ...
        myChart.on('click', function(params) {
          ...
          if (that.option.series[params.seriesIndex].pieStatus) {
...
.chart-container {
  ...
  .bg {
    ...
    background-image: url('../../../assets/img/scale/chart_opacity_bg.png');
